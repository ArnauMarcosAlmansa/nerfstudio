...
from nerfstudio.models.polarization import PolarizationModelConfig
...
method_configs["polarization"] = TrainerConfig(
    ...
    logging=LoggingConfig(
        local_writer=LocalWriterConfig(enable=True, stats_to_track=(
